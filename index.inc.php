...
$newContent = array(date("d.m.Y, H:i:s") . ", 
" . $_SERVER["REMOTE_ADDR"] . ",
...
<head>
  <title>PHP-PP by Direkt SPEED</title>
...
<div id="container">
  <h1 id="title">PHP-PP</h1>
  <p><a href="https://github.com/frank-dspeed/PHP-PP">Visit Source on GitHub</a></p>
  <ul id="navigation">
...
?>
  ...
  <div id="footer"><a href="http://dspeed.eu">A PHP Application that Modifys Content from a given src </a> <?php echo $GLOBALS['_version'] ?></div>
</div>
</body>
</html>
